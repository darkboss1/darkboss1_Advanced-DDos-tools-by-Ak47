...
# Logo
echo -e "${BLUE}╔══════════════════════════════════════╗"
echo -e "${RED}║      Installing darkboss1-DDOS-Boss   ║"
echo -e "${BLUE}╚══════════════════════════════════════╝${NC}"
...
# Permission fix
chmod +x darkboss1_Advanced-DDos-tools-by-Ak47.py

# Final message
echo -e "${GREEN}"
echo "=============================================="
echo "  Vampire-DDOS-X Installed Successfully!"
echo -e "  ${CYAN}To Run The Main Tool:${NC} ${YELLOW}python3 darkboss1_Advanced-DDos-tools-by-Ak47-ddos.py${NC}" 
echo -e "  ${CYAN}To Run The 2nd Tool:${NC} ${YELLOW}python3 darkboss1_Advanced-DDos-tools-by-Ak47_ddos_boss.py${NC}"
echo ""
echo "  Coded by: darkboss1 (Ak47)"
echo "=============================================="
echo -e "${NC}"
